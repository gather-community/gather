...
Devise.setup do |config|
  ...
  # config.pepper = '7d369921bf34816bd8937278142392bf51ac9e1c326f38fc5d6e273abc0447735eb9db1bd524bb8a0a142f257d5154855bc4cf327889171ea66519041672257d'
  ...
  # one (and only one) @ exists in the given string, there is no whitespace,
  # and there is a period after the @.
  ...
  # SEE LOCAL CONFIG FOR THIS SETTING
