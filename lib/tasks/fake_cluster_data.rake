...
namespace :fake do
  task :cluster_data, [:cluster_id, :community_id] => :environment do |t, args|
    raise "Please specify cluster ID, e.g. rake fake:cluster_data[123]" unless args.cluster_id.present?
