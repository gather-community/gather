...
describe GDrive::PermissionSyncJob do
  ...
  describe "api failures" do
    ...
    let!(:token) do
      create(:gdrive_token, gdrive_config: config, google_user_id: "drive.admin@gocoho.net",
                            access_token: "ya29.a0Ael9sCMPTeNxxkfXMuruUgqNWNWGhiGWo52QnzdUV6ibuveSYkFcc0cEpdXSB4Yxq_w8CgXewkrKc3ieM-zvCHjdGaG-xVmnFKHJNVURD7agjGJ8PDKJPA6RXtcF-VeIrSwaoF3_n_xlx_IzN7cIIV7yHKyNkbLo-AaCgYKAR0SARESFQF4udJh78dP-tj8BtC-ilrCan06jw0169")
    end
