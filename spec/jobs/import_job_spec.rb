...
# Tests the generic ImportJob class using Meals::CsvImport
describe ImportJob do
  ...
  context "happy path" do
    let(:meal_import) { create(:meal_csv_import, community: community, csv: "") }

    it "calls import" do
      perform_job(class_name: "Meals::CsvImport", id: meal_import.id)
  ...
  context "with unhandled error" do
    ...
    let(:meal_import) { create(:meal_csv_import, community: community, csv: nil) }
