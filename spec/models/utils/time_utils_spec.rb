...
describe Utils::TimeUtils do
  describe "humanize_interval" do
    ...
    it "works for 1 day" do
      expect(Utils::TimeUtils.humanize_interval(86_400)).to eq("24 hours")
    end

    it "works for 1 day plus a bit" do
      expect(Utils::TimeUtils.humanize_interval(86_401)).to eq("24 hours")
    end

    it "works for 1 day plus a minute" do
      expect(Utils::TimeUtils.humanize_interval(86_460)).to eq("24 hours 1 minute")
    end

    it "works for 5 days" do
      expect(Utils::TimeUtils.humanize_interval(5 * 86_400)).to eq("120 hours")
    end
  end
end
