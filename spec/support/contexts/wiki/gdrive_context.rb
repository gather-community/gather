...
shared_context "gdrive" do
  ...
  # This should only be necessary for tests of the oauth flow. For tests of other GDrive endpoints, we
  # should only need to include a working access_token. See the GDrive::Config factory for more info.
